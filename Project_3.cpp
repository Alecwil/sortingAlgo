	...
	if (strcmp(argv[1], "-a") == 0) {
		...
		if (argc == 5) { //command 4
			...
			for (int i = 0; i < 2; i++)
			{
				...
				else if (strcmp(argv[i + 2], "shell-sort") == 0)
					cout << fixed << setprecision(4) << shellSortRT(aTemp, inputSize) << " ms";
				else if (strcmp(argv[i + 2], "count-sort") == 0)
			...
			for (int i = 0; i < 2; i++)
			{
				...
				if (strcmp(argv[i + 2], "selection-sort") == 0)
					...
					cout << shellSortCMP(aTemp, inputSize);
				else if (strcmp(argv[i + 2], "count-sort") == 0)
